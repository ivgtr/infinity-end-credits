...
import { generateNames, generateCompanyName, generateCharacterName, funnyRoles, famousDirectors } from "./generate";
...
export const generateRoleStaff = () => {
  ...
  if (Math.random() < 0.001) {
    ...
    if (selectedEasterEgg === "famous_director") {
      ...
      staffs.push({
        role: selectedRole as keyof typeof EVANGELIONRole,
